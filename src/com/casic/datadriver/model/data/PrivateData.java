...
public class PrivateData extends BaseModel{
    ...
    private String ddDataSenMin;

    private String ddDataSenMax;
    ...
    public String getDdDataSenMin() {
        return ddDataSenMin;
    }

    public void setDdDataSenMin(String ddDataSenMin) {
        this.ddDataSenMin = ddDataSenMin;
    }

    public String getDdDataSenMax() {
        return ddDataSenMax;
    }

    public void setDdDataSenMax(String ddDataSenMax) {
