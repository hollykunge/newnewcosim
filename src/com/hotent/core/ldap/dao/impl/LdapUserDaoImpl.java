...
public class LdapUserDaoImpl implements LdapUserDao {
	...
	@Override
	public List<LdapUser> getAll(Map<String,String> params) {
	 ...
	 * 通过分页，查询用户
	 *  (non-Javadoc)
	 * @see LdapUserDao#get(PagedResultsCookie, int)
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	public boolean authenticate(String userId,String password){
		AndFilter filter = new AndFilter();
		 filter.and(new EqualsFilter("objectcategory",LdapUser.OBJECTCLASS)).and(new EqualsFilter(LdapUser.KEY_SAMACCOUNTNAME,userId));
