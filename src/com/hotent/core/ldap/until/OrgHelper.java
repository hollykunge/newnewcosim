...
public class OrgHelper {
	 ...
	 * @return
	 */
	public static List<ISysOrg> setOrgPath(List<ISysOrg> orgs) {
	 ...
	 * @return
	 */
	public static ISysOrg getOrgByDn(String dn,List<ISysOrg> orgs){
	 ...
	 * @return
	 */
	public static List<String> getOrgsNamePaths(List<ISysOrg> orgs) {
		...
		for (ISysOrg org : orgs) {
			...
			for (int i = 1; i < ids.length; i++) {
				...
				if (!StringUtil.isEmpty(id)) {
					ISysOrg org2 = getSysOrgById(orgs, Long.parseLong(id));
					if (org2 == null) {
	 ...
	 * @return
	 */
	public static String getOrgsNamePath(ISysOrg org,List<ISysOrg> searchOrgs) {
		String namePath = "";
		String[] ids = org.getPath().split("\\.");
		for (int i = 1; i < ids.length; i++) {
			String id = ids[i];
	 ...
	 * @return
	 */
	public static List<ISysOrg> getSysOrgByFromType(List<ISysOrg> orgs, short fromType) {
	 ...
	 * @return
	 */
	private static String calcPath(ISysOrg org, List<ISysOrg> orgs) {
		if (org.getOrgSupId() == 1) {
			return "1.";
		}
		for (ISysOrg org2 : orgs) {
