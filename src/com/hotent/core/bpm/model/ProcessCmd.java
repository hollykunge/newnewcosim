...
public class ProcessCmd{	
	...
	private String[] nextTaskExecutorIds;
	...
	/**
	 * 是否为代理任务，若是，则代表当前执行人代替任务对应的执行人来完成该任务
	 */
	...
	public String[] getNextTaskExecutorIds() {
		return nextTaskExecutorIds;
	}
	public void setNextTaskExecutorIds(String[] nextTaskExecutorIds) {
		this.nextTaskExecutorIds = nextTaskExecutorIds;
	}
