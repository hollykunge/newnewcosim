...
public class SystemConst {
	...
	public final static String SEARCH_BY_ENTERPRIES="5";//从企业     // modifyBy hotent.xianggang
	...
	/**
	 * Cglib动态类转换json时候的字段前缀 
	 */
	public final static String PREFIXOFCGLIBPROP = "\\$cglib_prop_";
