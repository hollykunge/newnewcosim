...
<#macro genCondition field>
	<#if field.getPropertyMap().condValFrom=="1" >
	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group"><a class="link add" href="${ctxPath}/platform/form/bpmFormHandler/bizForm.ht?formKey=${formKey}">添加</a></div>
				<div class="l-bar-separator"></div>
			...
			<table cellpadding="1" cellspacing="1" class="table-grid table-list">
				...
				<tr class="<#noparse><#if data_index % 2 == 0>odd</#if><#if data_index % 2 == 1>even</#if></#noparse>">
					...
					<td>
						...
						<a href="${ctxPath}/platform/form/bpmFormHandler/bizForm.ht?formKey=${formKey}&id=<#noparse>${data.id}</#noparse>" class="link edit">编辑</a>
						<a href="${ctxPath}/platform/form/bpmFormHandler/del.ht?formKey=${formKey}&id=<#noparse>${data.id}</#noparse>" class="link del">删除</a>
					</td>
				</tr>
