...
<div class="panel">
	...
	<div class="panel-body">
		...
		$(function(){
			var cssFiles=[
				"${ctx}/js/tree/v33/zTreeStyle.css"
			];
			...
			var jsFiles=[
				"${ctx}/js/tree/v33/jquery.ztree.core-3.3.js",
				"${ctx}/js/tree/v33/jquery.ztree.excheck-3.3.min.js",
				"${ctx}/js/tree/v33/jquery.ztree.exedit-3.3.min.js",
