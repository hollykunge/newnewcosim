...
$("#select-first_edit").change(function(){
    //清空二级select的旧选项
    ...
    if(firstValue == ''){
        $("#select-second_edit").fadeOut("slow");
        return;
    }
    ...
    $.ajax({
        ...
        success:function(datas){
            ...
            $("#select-second_edit").selectpicker('deselectAll');
        },
        error:function(){
            console.log("请求当前组织的用户失败！" + "union-select_edit.js");
        }
