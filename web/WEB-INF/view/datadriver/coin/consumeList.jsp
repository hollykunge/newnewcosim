...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <display:table name="scoreOutflowList" id="scoreOutflowItem" requestURI="consumelist.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
