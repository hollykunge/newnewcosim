	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">企业审核信息列表</span>
			</div>
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link search" id="btnSearch">查询</a></div>
					<div class="group"><a class="link update"  action="updateStateToWSH.ht">置为未审核</a></div>
					<div class="l-bar-separator"></div>
				</div>	
			</div>
			<div class="panel-search">
				<form id="searchForm" method="post" action="list_ysh.ht">
					<div class="row">
		...
		<div class="panel-body">
		    ...
		    <display:table name="InfoList" id="InfoItem" requestURI="list_wsh.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
				...
				<display:column  title="注册时间" sortable="true" sortName="registertime">
					<fmt:formatDate value="${InfoItem.registertime}" pattern="yyyy-MM-dd"/>
				</display:column>
