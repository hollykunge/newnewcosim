		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link update"  action="toEdit.ht">修改</a></div>
					<div class="l-bar-separator"></div>
					<div class="group"><a class="link dep" id="btnUpd" action="dep.ht">发布</a></div>
					<div class="l-bar-separator"></div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="materialList" id="materialItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
				...
				<display:column title="管理" media="html" style="width:230px">
					<a href="del.ht?id=${materialItem.id}" class="link del">删除</a>
					<a href="toEdit.ht?id=${materialItem.id}" class="link edit">编辑</a>
					<a href="dep.ht?id=${materialItem.id}" class="link edit">发布</a>
