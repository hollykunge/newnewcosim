	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="getAllList.ht">
					<div class="row">
						...
						<span class="label">商机类型:</span>
						          <select  name="Q_type_SL" id="type"  >
					                    ...
					                    <option value="采购商机">采购商机</option>
					                    <option value="营销商机">营销商机</option>
					                    <option value="服务商机">服务商机</option>
					                    <option value="生产商机">生产商机</option>
					                    <option value="研发商机">研发商机</option>
					             </select>
		...
		<div class="panel-body">
		    ...
		    <display:table name="businessChanceList" id="businessChanceItem" requestURI="getAllList.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
				...
				<display:column property="type" title="商机类型" sortable="true" sortName="type"></display:column>
