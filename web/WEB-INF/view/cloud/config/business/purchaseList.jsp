	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="purchaseList.ht">
					<div class="row">
		...
		<div class="panel-body">
		    ...
		    <display:table name="businessChanceList" id="businessChanceItem" requestURI="purchaseList.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
				...
				<display:column property="properties" title="采购数量" sortable="true" sortName="properties" maxLength="80"></display:column>
