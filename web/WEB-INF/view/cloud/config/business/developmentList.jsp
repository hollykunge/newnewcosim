	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="developmentList.ht">
					<div class="row">
						...
						<span class="label">发布状态:</span><input type="text" name="Q_publishState_SL"  class="inputText" />
				</form>
			</div>
		</div>
		<div class="panel-body">
		    ...
		    <display:table name="businessChanceList" id="businessChanceItem" requestURI="developmentList.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
				...
				<display:column property="properties" title="研发要求" sortable="true" sortName="properties" maxLength="80"></display:column>
				...
				<display:column title="管理" media="html" style="width:200px">
					...
					<a href="change.ht?id=${businessChanceItem.id}" class="link edit">审核</a>
