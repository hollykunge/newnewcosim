...
<head>
	...
	<script type="text/javascript">
		...
		//当前访问
		var returnUrl="${ctx}/cloud/warehouse/warehouseAccounts/list.ht";
		$(function()
		{
			loadTree();
			layout();
		...
		function loadTree(){
			...
			var setting = {
				...
				async: {
					enable: true,
					url:"${ctx}/cloud/warehouse/warehouseArchive/getChildTreeData.ht",
		...
		function zTreeOnLeftClick(event, treeId, treeNode){
			...
			returnUrl="${ctx}/cloud/warehouse/warehouseAccounts/list.ht?warehouseid="+treeNode.id;
		...
		function treeExpand() {
			...
			posTree.expandNode(treeNodes[0], true, false, false);
...
<div id="layout">
	...
	<div position="center">
		<iframe id="listFrame" src="${ctx}/cloud/warehouse/warehouseAccounts/list.ht" frameborder="no" width="100%" height="100%"></iframe>
	</div>
