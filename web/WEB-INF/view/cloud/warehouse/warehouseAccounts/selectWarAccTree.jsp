...
<head>
	...
	<script type="text/javascript">
		...
		//当前访问
		var returnUrl="${ctx}/cloud/config/material/listMyMaterials.ht";
		$(function()
		{
			loadTree();
			layout();
		...
		function zTreeOnLeftClick(event, treeId, treeNode){
			...
			returnUrl="${ctx}/cloud/warehouse/warehouseAccounts/myWarehouseAccountList.ht?warehouseid="+treeNode.id;
