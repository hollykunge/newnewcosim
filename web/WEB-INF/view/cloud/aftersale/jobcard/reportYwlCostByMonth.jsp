...
<script>
//判断是否柱状图显示还是曲线显示
function rendarChart(type,startDate,endDate){
	type = type || "Column3D6";
	...
	var url="reportYwlCostByMonthWithJson.ht?year="+$("#year").val()+"&startDate="+startDate+"&endDate="+endDate;
...
$(function(){
	...
	$('#btnSearch').click(function(){	
		rendarChart($(":input[name=showType]:checked").val(),$(":input[name='startDate']").val(),$(":input[name='endDate']").val());
	});
	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">业务量统计</span>
			</div>
			<div class="panel-toolbar">
				<div class="toolBar" style="font-size:12px;">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;年份：<select id="year"><option>2013<option><option>2014<option><option>2015<option><option>2016<option></select>
				</div>	
			</div>
			 
		</div>
		<div class="panel-body">
        	<div id="chartdiv" align="center">业务量统计</div>
		</div>	
	</div> <!-- end of panel -->
</body>
</html>
