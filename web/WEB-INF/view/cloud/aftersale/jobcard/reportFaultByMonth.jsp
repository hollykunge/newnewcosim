...
function rendarChart(type,faultType,startDate,endDate){
	...
	var url="reportFaultByMonthWithJson.ht?type="+faultType+"&startDate="+startDate+"&endDate="+endDate;
	...
	<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="reportByMonth.ht">
					<div class="row" style="font-size:12px;">
						...
						<span class="label">维修时间从:</span><input type="text" name="startDate"  class="inputText date" />
						<span class="label">至:</span><input type="text" name="endDate"  class="inputText date" />
					</div>
				</form>
			</div>
		</div>
		<div class="panel-body">
        	<div id="chartdiv" align="center">月度维修统计</div>
		</div>	
	</div> <!-- end of panel -->
</body>
</html>
