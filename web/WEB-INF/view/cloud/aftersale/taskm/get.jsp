...
<body>
	<div class="panel">
		...
		<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				<th style="width:120px;">产品名称</th><td>${taskM.prodname}</td>
				<th style="width:120px;">产品型号</th><td>${taskM.prodmodel}</td></tr>				
				<tr><th>问题描述</th><td colspan="3">${taskM.descn}</td></tr>
				<tr><th>维修厂商</th><td colspan="3">
				${taskM.purenter_name}
				</td>
			</tr>
			<tr>
