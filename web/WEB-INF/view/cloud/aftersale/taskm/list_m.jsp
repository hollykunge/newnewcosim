	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">内部日常维修-维修任务单列表</span>
			</div>
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="l-bar-separator"></div>
					<!-- 
					<div class="group"><a class="link update" id="btnUpd" action="edit_m.ht">修改</a></div>
					<div class="l-bar-separator"></div>
		...
		<div class="panel-body">
		    ...
		    <display:table name="taskMList" id="taskMItem" requestURI="list_m.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
				...
				<display:column property="accendant_name" title="维修人员" sortable="true" sortName="accendant_name" ></display:column>
				<display:column title="管理" media="html" style="width:180px">
					<a href="get_m.ht?id=${taskMItem.id}" class="link detail">明细</a>
