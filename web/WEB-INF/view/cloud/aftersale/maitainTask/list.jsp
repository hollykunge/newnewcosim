	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">现场技术服务管理列表</span>
			</div>
				...
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						...
						<select name="Q_state_SE" class="inputText"  >
							...
							<option value="1-发起维修任务">1-发起维修任务</option> 
							<option value="2-向客户报价">2-向客户报价</option>
							<option value="3-客户审核报价">3-客户审核报价</option>
							<option value="4-指派维修人员">4-指派维修人员</option>
							<option value="5-填写维修工单">5-填写维修工单</option>
							<option value="6-售后主管审核">6-售后主管审核</option>
