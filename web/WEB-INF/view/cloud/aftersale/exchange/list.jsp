	...
	<div class="panel">
		<div class="panel-top">
			<div class="tbar-title">
				<span class="tbar-label">更换单管理列表</span>
			</div>
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						...
						<!-- <span class="label">更换原因:</span><input type="text" name="Q_reason_SL"  class="inputText" />
		...
		<div class="panel-body">
		    ...
		    <display:table name="exChangeList" id="exChangeItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
				<display:column title="${checkAll}" media="html" style="width:30px;">
			  		<input type="checkbox" class="pk" name="id" value="${exChangeItem.id}">
				</display:column>
				<display:column property="code" title="单证号" sortable="true" sortName="code"></display:column>
				<%-- <display:column property="reason" title="更换原因" sortable="true" sortName="reason" maxLength="80"></display:column> --%>
				...
				<display:column  title="制单日期" sortable="true" sortName="operatedate">
					<fmt:formatDate value="${exChangeItem.operatedate}" pattern="yyyy-MM-dd"/>
				</display:column>
				...
				<display:column title="管理" media="html" style="width:180px">
					<a href="get.ht?id=${exChangeItem.id}" class="link detail">明细</a>
					
				</display:column>
			</display:table>
			<hotent:paging tableId="exChangeItem"/>
