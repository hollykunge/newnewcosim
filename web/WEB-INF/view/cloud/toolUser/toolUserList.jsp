...
<body style="overflow-x: hidden;overflow-y: auto;">
	...
	<div class="panel-search" style="width: 80%;">
		<form id="searchForm" method="post" action="${ctx}/cloud/tool/toolUserList.ht" >
			<div class="row">
	...
	<display:table  name="toolList" id="toolItem" requestURI="toolList.ht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
		<display:column title="${checkAll}" media="html" style="width:30px;">
			<input onchange="window.parent.selectMulti(this);" type="checkbox" class="pk" name="userData" value="${toolItem.toolUserId}#${toolItem.toolName}#${toolItem.toolType}#${toolItem.toolTypeAsString}#${toolItem.toolAddress}">
		</display:column>
		...
		<display:column property="toolAddress" title="用户工具缺省地址" sortable="true" sortName="toolAddress" maxLength="40"></display:column>
