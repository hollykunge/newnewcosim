...
<script type="text/javascript">
	...
	function toRight(){
		...
		$('#myFriendsList').find(':checkbox:checked').each(function(){
			...
			//给对象赋值
			friend.id = $($tds[0]).find(':checkbox').val();
...
<div class="left">
	...
	<display:table name="myFriendsList" id="myFriendsList"
		...
		<display:column title="全选" media="html" style="width:30px;">
...
<!-- 角色列表  -->
<div class="middle" style="padding-left: 5px;">
	<display:table name="rolesList" id="rolesList" requestURI="list.ht" 
		...
		<display:column title="全选" media="html" style="width:30px;">
			<input type="radio" class="pk" name="id" value="${rolesList.roleId}">
		</display:column>
...
<div class="right">
	<display:table name="selectedRoles" id="selectedRoles" requestURI="list.ht" 
		...
		<display:column title="全选" media="html" style="width:20px;">
