		...
		<div class="panel-body">
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
						<div class="row">
							<span class="label">所属报表:</span><input type="text" name="Q_REPORTID_SL"  class="inputText" value="${param['Q_REPORTID_SL']}"/>
							<span class="label">参数名称:</span><input type="text" name="Q_PARAMNAME_SL"  class="inputText" value="${param['Q_PARAMNAME_SL']}"/>
							<span class="label">参数Key:</span><input type="text" name="Q_PARAMKEY_SL"  class="inputText" value="${param['Q_PARAMKEY_SL']}"/>
							<span class="label">缺省值:</span><input type="text" name="Q_DEFAULTVAL_SL"  class="inputText" value="${param['Q_DEFAULTVAL_SL']}"/>
							<span class="label">类型:</span><input type="text" name="Q_PARAMTYPE_SL"  class="inputText" value="${param['Q_PARAMTYPE_SL']}"/>
							<span class="label">系列号:</span><input type="text" name="Q_SN_SL"  class="inputText" value="${param['Q_SN_SL']}"/>
							<span class="label">PARAMTYPESTR:</span><input type="text" name="Q_PARAMTYPESTR_SL"  class="inputText" value="${param['Q_PARAMTYPESTR_SL']}"/>
						</div>
				</form>
			</div>
			<br/>
