					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<div class="row">
												...
												<span class="label">收件人:</span><input type="text" name="Q_receiver_SL"  class="inputText" value="${param['Q_receiver_SL']}"/>
											
												<span class="label">抄送:</span><input type="text" name="Q_copyTo_SL"  class="inputText" value="${param['Q_copyTo_SL']}"/>
											
												<span class="label">秘密抄送:</span><input type="text" name="Q_bcc_SL"  class="inputText" value="${param['Q_bcc_SL']}"/>
											
												<span class="label">发件人:</span><input type="text" name="Q_fromUser_SL"  class="inputText" value="${param['Q_fromUser_SL']}"/>
											
												<span class="label">内容模版:</span><input type="text" name="Q_templateId_S"  class="inputText" value="${param['Q_templateId_S']}"/>
											
												<span class="label">消息类型:</span><input type="text" name="Q_messageType_S"  class="inputText" value="${param['Q_messageType_S']}"/>
