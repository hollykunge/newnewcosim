		...
		<div class="panel-body">
			<div class="panel-search">
					<form id="searchForm" method="post" action="list.ht">
							<div class="row">
										<span class="label">用户ID:</span><input type="text" name="Q_userId_S"  class="inputText" value="${param['Q_userId_S']}"/>
									
										<span class="label">布局ID:</span><input type="text" name="Q_layoutId_S"  class="inputText" value="${param['Q_layoutId_S']}"/>
									
										<span class="label">栏目ID:</span><input type="text" name="Q_columnId_S"  class="inputText" value="${param['Q_columnId_S']}"/>
									
										<span class="label">列:</span><input type="text" name="Q_col_SN"  class="inputText" value="${param['Q_col_SN']}"/>
									
										<span class="label">序号:</span><input type="text" name="Q_sn_S"  class="inputText" value="${param['Q_sn_S']}"/>
							</div>
					</form>
			</div>
			<br/>
