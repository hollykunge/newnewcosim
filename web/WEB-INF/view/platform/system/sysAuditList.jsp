...
<div class="panel">
    ...
    <div class="panel-top">
        ...
        <div class="panel-toolbar">
            <div class="toolBar">
                ...
                <c:if test="${sysAuditItem.executorId==1}">
    ...
    <div class="panel-body">
        ...
        <display:table name="sysAuditList" id="sysAuditItem" requestURI="list.ht" sort="external" cellpadding="1"
