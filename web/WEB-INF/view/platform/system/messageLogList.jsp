...
<body>
	<div class="panel">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						...
						<span class="label">发送时间 从:</span> <input  name="Q_beginSendTime_DL"  class="inputText date" value="${param['Q_beginSendTime_DL']}"/>
						<span class="label">至: </span><input  name="Q_endSendTime_DG" class="inputText date" value="${param['Q_endSendTime_DG']}"/>
						<span class="label">接收者:</span><input type="text" name="Q_receiver_SL"  class="inputText" value="${param['Q_receiver_SL']}"/>
		...
		<div class="panel-body">
		    ...
		    <display:table name="messageLogList" id="messageLogItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
