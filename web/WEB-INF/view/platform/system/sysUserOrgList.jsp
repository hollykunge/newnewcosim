				...
				<div class="panel-body">
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<div class="row">
												<span class="label">组织ID:</span><input type="text" name="Q_orgId_S"  class="inputText" value="${param['Q_orgId_S']}"/>
											
												<span class="label">userId:</span><input type="text" name="Q_userId_S"  class="inputText" value="${param['Q_userId_S']}"/>
											
												<span class="label">是否为主要:</span><input type="text" name="Q_isPrimary_SN"  class="inputText" value="${param['Q_isPrimary_SN']}"/>
											
												<span class="label">组织负责人ID:</span><input type="text" name="Q_isCharge_S"  class="inputText" value="${param['Q_isCharge_S']}"/>
