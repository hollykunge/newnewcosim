			...
			<div class="panel">
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link  sendMessage" href="edit.ht">发送消息</a></div>
							<div class="l-bar-separator"></div>
					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<div class="row">
												...
												<span class="label">发送时间:</span> <input  name="Q_beginsendTime_DL"  class="inputText datetime" value="${param['Q_beginsendTime_DL']}"/>
												<span class="label">至: </span><input  name="Q_endsendTime_DG" class="inputText datetime" value="${param['Q_endsendTime_DG']}"/>
									</div>
							</form>
					</div>
				</div>
				<div class="panel-body">
				    ...
				    <display:table name="messageSendList" id="messageSendItem" requestURI="list.ht" 
						...
						<display:column title="收信人" sortable="true" sortName="receiverName" style="text-align:center;">
						<c:choose>
