		...
		<div class="panel-top">
			...
			<div class="panel-search">
					<form id="searchForm" method="post" action="list.ht">
							<div class="row">
										<span class="label">数据源名称:</span><input type="text" name="Q_name_SL"  class="inputText" value="${param['Q_name_SL']}"/>
										...
										<select id="Q_dbType_S"  name="Q_dbType_S">
											...
											<option value="sql2005" <c:if test="${param['Q_dbType_S'] == 'sql2005'}">selected</c:if>>MSSQL2005</option>
			    ...
			    <display:table name="sysDataSourceList" id="sysDataSourceItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
					...
					<display:column   title="数据库类型" >
							<c:choose>
								...
								<c:when test="${sysDataSourceItem.dbType=='sql2005'}">MSSQL2005</c:when>
