				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link add"  href="sysRole/add1.ht">添加</a></div>
							<div class="l-bar-separator"></div>
							<div class="group"><a class="link  update" id="btnUpd" action="sysRole/upd1.ht">修改</a></div>
							<div class="l-bar-separator"></div>
							<div class="group"><a class="link del"  action="sysRole/del.ht">删除</a></div>
						</div>	
					</div>
				</div>
				<div class="panel-body">
					<div class="panel-search">
							<form id="searchForm" method="post" action="sysRoles.ht">
									<div class="row">
												<span class="label">系统ID:</span><input type="text" name="Q_systemId_L"  class="inputText" value="${param['Q_systemId_L']}"/>
												<span class="label">角色别名:</span><input type="text" name="Q_alias_S"  class="inputText" value="${param['Q_alias_S']}"/>
												<span class="label">角色名:</span><input type="text" name="Q_roleName_S"  class="inputText" value="${param['Q_roleName_S']}"/>
												<span class="label">备注:</span><input type="text" name="Q_memo_S"  class="inputText" value="${param['Q_memo_S']}"/>
												<span class="label">允许删除:</span><input type="text" name="Q_allowDel_SN"  class="inputText" value="${param['Q_allowDel_SN']}"/>
												<span class="label">允许编辑:</span><input type="text" name="Q_allowEdit_SN"  class="inputText" value="${param['Q_allowEdit_SN']}"/>
												<span class="label">是否启用</span><input type="text" name="Q_enabled_SN"  class="inputText" value="${param['Q_enabled_SN']}"/>
									</div>
							</form>
					</div>
					<br/>
