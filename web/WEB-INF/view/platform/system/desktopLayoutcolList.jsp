				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
                            ...
                            <div class="l-bar-separator"></div>
							<div class="group"><a class="link show"  action="show.ht">图型显示</a></div>							
						</div>	
					</div>
				</div>
				<div class="panel-body">
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.ht">
									<div class="row">
										<span class="label">布局名称:</span><input type="text" name="Q_layoutId_S"  class="inputText" value="${param['Q_layoutId_S']}"/>
									</div>
							</form>
					</div>
					<br/>
