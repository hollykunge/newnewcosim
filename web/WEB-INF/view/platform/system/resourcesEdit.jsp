        ...
        <div class="panel-body">
            <table id="resourcesTable" class="table-detail" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td><input type="text" id="resName" name="resName" value="${resources.resName}" class="inputText"/>
                    </td>
                </tr>
                <tr>
                    <th width="20%">资源别名:</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <img id="iconImg" alt="" src="${resources.icon}"
                             <c:if test="${resources.icon==null}">style="display:none;"</c:if>>
                        <a class="link detail" href="javascript:selectIcon();">选择</a>
                    </td>
                </tr>
                <tr>
                    <th width="20%">默认地址:</th>
                    <td><input type="text" id="defaultUrl" name="defaultUrl" size="60" value="${resources.defaultUrl}"
                               class="inputText"/></td>
                </tr>
                <tr>
                    <th width="20%">是否栏目:</th>
                    <td>
                        <select id="isFolder" name="isFolder">
                            <option value="0" <c:if test="${resources.isFolder==0}">selected="selected"</c:if>>否
                            </option>
                            <option value="1" <c:if test="${resources.isFolder==1}">selected="selected"</c:if>>是
                            </option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="isDisplayInMenu" name="isDisplayInMenu">
                            <option value="0" <c:if test="${resources.isDisplayInMenu==0}">selected="selected"</c:if>>
                                否
                            </option>
                            <option value="1" <c:if test="${resources.isDisplayInMenu==1}">selected="selected"</c:if>>
                                是
                            </option>
                        </select>
                    </td>
                ...
                <tr style="display: none;">
                    <th width="20%">父ID:</th>
                    <td><input type="text" id="parentId" name="parentId" value="${resources.parentId}"
                               class="inputText"/></td>
                </tr>
                <tr style="display: none;">
                    <th width="20%">systemId:</th>
                    <td><input type="text" id="systemId" name="systemId" value="${resources.systemId}"
                               class="inputText"/></td>
                </tr>
            ...
            <div class="panel-body">
                ...
                <table id="resourcesUrlItem" class="table-grid table-list" id="0" cellpadding="1" cellspacing="1">
                    ...
                    <c:forEach items="${resourcesUrlList}" var="resourcesUrlItem">
                        <tr>
                            <td style="text-align: center;">
                                <input name="chDefaultUrl" type="radio"
                                       <c:if test="${resourcesUrlItem.url==resources.defaultUrl}">checked="checked"</c:if>
                                       onclick="setDefaultUrl(this);">
                            </td>
                            <td style="text-align: center;">
                                <input class="inputText" type="text" name="name" style="width: 95%;"
                                       value="${resourcesUrlItem.name}">
                            </td>
                            <td style="text-align: center;">
                                <input class="inputText" type="text" name="url" style="width: 95%;"
                                       value="${resourcesUrlItem.url}">
                            </td>
                            <td style="text-align: center;">
                                <a href="javascript:void(0)" class="link del" onclick="singleDell(this);">删除</a>
                            </td>
