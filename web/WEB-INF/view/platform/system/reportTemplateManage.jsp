...
<%@page import="com.deloitte.platform.model.system.GlobalType"%>
...
<script type="text/javascript" src="${ctx}/js/deloitte/platform/system/GlobalMenu.js"></script>
<script type="text/javascript" src="${ctx}/js/deloitte/platform/form/GlobalType.js"></script>
