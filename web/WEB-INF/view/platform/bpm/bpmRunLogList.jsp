...
<body>
			<div class="panel panel-default">
						...
						<div class="panel-search">
								<form id="searchForm" method="post" action="list.ht">
										<div class="row">
											...
											<span class="label">用户名称:</span><input type="text" name="Q_username_SL"  class="inputText"  value="${param['Q_username_SL']}"/>
				...
				<div class="panel-footer">
					    ...
					    <display:table name="bpmRunLogList" id="bpmRunLogItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" class="table table-bordered table-hover">
							...
							<display:column property="processSubject" title="流程标题"  href="get.ht"  paramId="id" paramProperty="id"  style="width:155px;" sortable="true" sortName="processSubject" maxLength="15" class="active"></display:column>
							<display:column property="username" title="用户名称" style="width:150px;" sortable="true" sortName="username" class="active"></display:column>
							<display:column  title="操作时间" sortable="true" style="width:170px;" sortName="createtime" class="active">
								<fmt:formatDate value="${bpmRunLogItem.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>
							</display:column>
							<display:column title="操作类型" sortable="true" style="width:150px;" sortName="operatortype" class="active">
								<c:choose>
							...
							<display:column property="memo" title="备注" style="width:270px;" sortable="true" sortName="memo" maxLength="30" class="active"></display:column>
