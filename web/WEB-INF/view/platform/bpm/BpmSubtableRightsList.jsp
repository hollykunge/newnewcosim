			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="list.ht">
					<div class="row">
						...
						<span class="label">节点ID:</span><input type="text" name="Q_nodeid_S"  class="inputText" value="${param['Q_nodeid_S']}"/>
						<span class="label">子表表ID:</span><input type="text" name="Q_tableid_S"  class="inputText" value="${param['Q_tableid_S']}"/>
						<span class="label">权限类型(1,简单配置,2,脚本):</span><input type="text" name="Q_permissiontype_S"  class="inputText" value="${param['Q_permissiontype_S']}"/>
						<span class="label">权限配置:</span><input type="text" name="Q_permissionseting_S"  class="inputText" value="${param['Q_permissionseting_S']}"/>
					</div>
				</form>
			</div>
		</div>
