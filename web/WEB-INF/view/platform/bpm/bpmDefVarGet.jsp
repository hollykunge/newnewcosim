...
<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link back"  href="../bpmDefVar/list.ht?defId=${bpmDefVar.defId}&actDeployId=${bpmDefVar.actDeployId}&actDefId=${actDefId}">返回</a></div>
				</div>
			</div>
		</div>
			...
			<div class="panel-detail">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<c:if test="${bpmDefVar.varScope eq 'taskInfo'}">局部</c:if>
							</td>
						</tr>
						<tr>
							<th width="20%">节点名称:</th>
