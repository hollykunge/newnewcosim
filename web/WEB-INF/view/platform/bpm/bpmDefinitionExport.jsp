			...
			<div class="row">
			 ...
			 <table id="tableid" class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
			 	...
			 	<tr>
					<th>自定义表单：</th>
					<td><input type="checkbox" id="bpmFormDef" name="bpmFormDef" value="true" onclick="onChecked(this,'bpmFormTable');"></td>
					<th>自定义表单对应的&nbsp;&nbsp;&nbsp;&nbsp;</br>自定义表：</th>
					<td><input type="checkbox" id="bpmFormTable"  name="bpmFormTable" value="true" onclick="onCheck(this,'bpmFormDef');"></td>
			 	</tr>
