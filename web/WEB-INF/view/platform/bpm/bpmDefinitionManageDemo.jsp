...
<html>
    <head>
        ...
        <script type="text/javascript">
            	...
            	function onClick( treeNode){
            		...
            		var url="${ctx}/platform/bpm/bpmDefinition/listDemo.ht?typeId="+typeId;
    ...
    <div position="left" title="流程分类管理" style="overflow: auto;float:left;width:100%">
            ...
            <div position="center" >
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/bpmDefinition/listDemo.ht"></iframe>
            </div>
        </div>
