				...
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							...
							<div class="group"><a class="link del"  action="delJobLog.ht">删除</a></div>
							<div class="l-bar-separator"></div>
					...
					<div class="panel-search">
							<form id="searchForm" method="post" action="getLogList.ht?jobName=${jobName }&trigName=${trigName}">
									<div class="row">
									            <span class="label">任务名称:</span><input type="text" name="Q_jobName_SL"  class="inputText" value="${param['Q_jobName_SL']}"/>
									            <span class="label">计划名称:</span><input type="text" name="Q_trigName_SL"  class="inputText" value="${param['Q_trigName_SL']}"/>
												<span class="label">时间从:</span> <input type="text" name="Q_startTime_DL"  class="inputText date" value="${param['Q_startTime_DL']}"/>
												<span class="label">至: </span><input type="text" name="Q_endTime_DG" class="inputText date" value="${param['Q_endTime_DG']}"/>
									</div>
							</form>
					</div>
				</div>
