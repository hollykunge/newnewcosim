				          						...
				          						<tr id='conditionVal${field.fieldName}'>
				          							...
				          							<td>
				          								<select name='changeDefalut' onchange='changeDefault(this)'>
				          									<option value="1" <c:if test="${field.defaultType=='1'}">selected</c:if>>表单输入</option>
				          							...
				          							<td colspan="2">
				          							<a <c:if test="${field.defaultType=='1' || field.defaultType=='2'}">style='display:none;'</c:if>  href='#' name='btnScript' 
				          							class='link var' title='常用脚本' onclick='selectScript(this)'>常用脚本</a>
				          							<textarea name='defaultValue' cols='40' rows='3' 
				          							<c:if test="${field.defaultType=='1' }">style='display:none;'</c:if>>${field.defaultValue}</textarea></td>
				          						</tr>
				          					</c:forEach>
				          				</tbody>
				          			</table>
