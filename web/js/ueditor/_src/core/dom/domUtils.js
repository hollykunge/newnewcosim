 ...
 */
    ...
    var domUtils = dom.domUtils = {
        ...
        replace:function(str,oldStr,newStr){
        	if(str==null||str==""||oldStr==null||oldStr==""||newStr==null)return "";
        ...
        addClass:function(nodes,className){
        	...
        	for(var i=0;i<nodes.length;i++){
        		if(nodes[i].className&&nodes[i].className.indexOf(className)>-1){
        			...
        			var oldClass=nodes[i].className?(nodes[i].className+" "):"";
        			nodes[i].className=oldClass+className;
        		}
        	}
        },
        /**
        ...
        removeClass:function(nodes,className){
        	...
        	while(node=nodes.pop()){
        		if(node.className&&node.className.indexOf(className)>-1){
        			var str=domUtils.replace(node.className,className,"");
        			str=utils.trim(str);
        			node.className=str;
        		}        		
        	}
