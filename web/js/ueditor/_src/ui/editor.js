                ...
                _onInputEditButtonClick:function(){
                	...
                	if(child){
                		...
                		if(external){
                			...
                			editor.execCommand(popup.anchorEl.className);
                			return;
                		}
            ...
            editor.addListener( 'mouseover', function( t, evt ) {
	    		...
	    		if(ifEl||ifElParent){
	    			var html = popup.formatHtml(
		                       '<nobr>属性: <span onclick="$$._onInputDelButtonClick()" class="edui-clickable">删除</span></nobr>');
	    			if(editor.options.editorModel){
	    				if(editor.options.editorModel=="designModel"){
	    					html = popup.formatHtml(
	 		                       '<nobr>属性: <span onclick="$$._onInputDelButtonClick()" class="edui-clickable">删除</span>&nbsp;&nbsp;' +	                       
	 		                       '<span onclick="$$._onInputEditButtonClick(event, this);" class="edui-clickable">修改</span>&nbsp;&nbsp;'+
	 		                       '</nobr>' );
	    				}
	    			}
				   if(ifInput){
					   html = popup.formatHtml(
	                       '<nobr>属性: <span onclick="$$._onInputDelButtonClick()" class="edui-clickable">删除</span>&nbsp;&nbsp;' +	                       
	                       '<span onclick="$$._onInputEditButtonClick(event, this);" class="edui-clickable">修改</span>&nbsp;&nbsp;'+
	                       '<span onclick="$$._onInputDialogButtonClick(event, this);" class="edui-clickable">自定义对话框</span></nobr>' );
				   }
