    ...
    */
    UE.commands['inserthtml'] = {
        execCommand: function (command,html,notSerialize){
            ...
            //在script标签中不能执行插入html的操作
            if(range.startContainer.tagName&&range.endContainer.tagName){
	            if(range.startContainer.tagName.toLowerCase()=='script'&&range.endContainer.tagName.toLowerCase()=='script'){
	            		alert("光标所在位置不适合执行该操作");
	            		return;
	            }
            }
