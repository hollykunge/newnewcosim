    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage','insertframe','|',
                ...
                'print', 'searchreplace','|','choosetemplate','input','opinion','|','taskopinion','flowchart','insertfunction']
        ]
        ...
        ,labelMap:{
            ...
            'imageleft':'左浮动', 'imageright':'右浮动','imagecenter':'居中','insertafterrow':'下插入行','insertaftercol':'右插入列','tableformat':'单元格样式刷',
            'lineheight':'行间距', 'customstyle':'自定义标题','input':'按钮','choosetemplate':'重新选择模板','customdialog':'自定义对话框','opinion':'意见',
            'taskopinion':'审批历史','flowchart':'流程示意图','insertfunction':'统计函数'
        }
