    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage','insertframe','horizontal','spechars', '|',
                'inserttable', 'deletetable', 'tableformat','insertrow', 'insertcol','insertafterrow' ,'insertaftercol', 'deleterow', 'deletecol','mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
                'print', 'searchreplace','|','choosetemplate','opinion','taskopinion','flowchart','input','insertfunction','|','hidedomain','textinput','textarea','checkbox',
                'radioinput','selectinput','|','dictionary','personpicker','departmentpicker','rolepicker','positionpicker','attachement','datepicker','officecontrol','subtable','ckeditor','importform','exportform']
        ]
        ...
        ,labelMap:{
            ...
            'unlink':'取消链接', 'insertrow':'上插入行', 'insertcol':'左插入列', 'mergeright':'右合并单元格', 'mergedown':'下合并单元格',
            ...
            'insertunorderedlist':'无序列表', 'fullscreen':'全屏', 'directionalityltr':'从左向右输入', 'directionalityrtl':'从右向左输入','input':'按钮','insertfunction':'统计函数',
            'RowSpacingTop':'段前距', 'RowSpacingBottom':'段后距','highlightcode':'插入代码', 'pagebreak':'分页', 'insertframe':'插入Iframe', 'imagenone':'默认',
            'imageleft':'左浮动', 'imageright':'右浮动','imagecenter':'居中','insertafterrow':'下插入行','insertaftercol':'右插入列','tableformat':'单元格样式刷','importform':'导入表单',
            'lineheight':'行间距', 'customstyle':'自定义标题','opinion':'意见','taskopinion':'审批历史','flowchart':'流程示意图','textinput':'单行文本框','hidedomain':'隐藏域','textarea':'多行文本',
            'checkbox':'复选框','radioinput':'单选按钮','selectinput':'下拉框','dictionary':'数据字典','personpicker':'人员选择器','departmentpicker':'部门选择器','datepicker':'日期选择器',
            'officecontrol':'office控件','subtable':'明细表','ckeditor':'ckeditor编辑器','rolepicker':'角色选择器','positionpicker':'岗位选择器','attachement':'附件上传工具','choosetemplate':'重新选择模板','exportform':'导出表单'
        }
        ...
        //,minFrameHeight:520 //最低高度，默认520px
