...
(function (b) {
    function n(c) {
        ...
        var d = b('<div class="dc_select"><div class="dropbox"><span class="text" style="float:none;"></span><span class="down"></span></div><ul class="dc_down_list" id="dc_select_abc"></ul><div style="clear:both;"></div></div>'), a = {
            box: d,
        ...
        a.dropbox[0].onclick = function () {
            if (!a.input.disabled) {
                ...
                if (a.first) {
                    a.first = !1;
                    var c = a.box.offset(), d = a.box.height(), h = c.top + d, c = a.list.height(), h = h + c + 20, g = b(window).height();
